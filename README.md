...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-avj0hnu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-avj0hnu.containers.anotherwebservice.com/
...
```
git clone git@github.com:Antonescu/container-avj0hnu.git
cd container-avj0hnu
```
...
```
docker attach container-avj0hnu
```
